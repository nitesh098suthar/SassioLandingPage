...
const Hero = () => {
  return (
    <div className=" border-red-200 bg-hero bg-cover grid place-items-center ">
      <div className=" flex-col justify-center items-center ">
        ...
        <div className="w-screen flex justify-center items-center">
          <div className="bg-hero-asset bg-contain mx-auto bg-center h-[70vh] w-[99%] bg-no-repeat">
