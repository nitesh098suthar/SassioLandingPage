...
const Footer = () => {
  return (
    <div className="container bg-white h-screen">
      <div className="bg-footer bg-center h-screen w-screen py-40">
        <div className="box h-36 bg-blue-800 w-1/2 mx-auto rounded-xl flex justify-around items-center">
          <h3 className="font-extrabold text-2xl">
            Join Sassio and Increase your Productivity
          </h3>
          <button>Get Started</button>
        </div>
        <div className="box flex justify-evenly my-16">
          <div className="boxes1 space-y-6">
            <div className="flex items-center">
              <div className="icon p-2 h-14 w-14 my-3">
                <img
                  src={logo}
                  alt=""
            ...
            <div className="toll-free">
              <p className="text-start text-sm py-1">Toll free customer care</p>
              <p className="font-bold text-sm text-start">+(1) 123 456 7890</p>
            </div>
            <div className="mail">
          ...
          <div className="boxes4 space-y-6">
            ...
            <div className="flex">
              <input
                ...
                className="h-12 px-2 py1 border-none bg-white rounded-lg"
              />
              <button className="bg-teal-500 ml-2">
                <BsArrowRightShort size={25} />
              </button>
            </div>
          </div>
        </div>
        <div className="box py-8 border-t-2">
